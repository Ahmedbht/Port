...
const allProjects = [
...
},
  {
    ...
    img: '/screen2.png',
    video: 'https://www.youtube.com/embed/LmCbASnAeas?si=8reO1DuvIvGuM9je',
...
liveUrl: 'https://azdoud.vercel.app',
  ...
  img: '/screen6.png',
  video: 'https://www.youtube.com/embed/2_-73TovAeg?si=qJG_1VidrTRaOn0H',
  ...
  id:11,
    ...
    img: '/scraper-pro.png',
    video: 'https://www.youtube.com/embed/WSkg-t3omSU?si=uC18CSmA0uCcOmkd',
  ...
  },
  {
    ...
    img: '/quizz pic.png',
    video: 'https://www.youtube.com/embed/EUfg2ty_Gjw?si=mLhTM4mRPkxz6mKw',
...
},
{
    ...
    tags: ['React', 'CSS'],
    img: '/readone.png',
    video: 'https://www.youtube.com/embed/w-_3lpZMQ2M?si=eu2fbPFmfqGlnk47',
    liveUrl: 'https://readone-amber.vercel.app/',
},
  {
    id: 14,
...
},
  {
    ...
    desc: 'Full stack management system for a local dairy brand: inventory, orders, and reporting. Landing page features an AI-powered chatbot (Groq API) that answers customer questions about products and services. Note: Frontend live, backend deployment in progress.',
